...
export default function ClientForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/auth/client/forgot-password', {
        method: 'POST',
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center mt-4">
                <Link href="/client/login" className="text-sm text-blue-600 hover:underline flex items-center justify-center">
